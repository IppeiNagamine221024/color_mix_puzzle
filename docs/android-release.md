...
[2] Play Console でアプリ作成（パッケージ名 com.wippeipy221024.colororder）
       ↓
[3] AdMob で Android アプリ・広告ユニット作成（✅ 済 ）
       ↓
...
**[https://ippeinagamine221024.github.io/app-ads.txt](https://ippeinagamine221024.github.io/app-ads.txt)**
...
1. `android/gradle.properties` または `android/app/build.gradle` に署名設定を追加（[Expo 署名ドキュメント](https://docs.expo.dev/app-signing/local-credentials/) 参照）
2. keystore ファイルは **リポジトリにコミットしない**（`.gitignore` に追加）
